...
export default class ProductContainer {
  ...
  async getAll() {
    try {
      ...
      return returnMessage(true, "Error requesting products", null);
    }
  }
  ...
  async deleteById(id) {
    try {
      ...
      if (!eliminatedProduct) {
        return returnMessage(true, "Product no found", null);
      }
      ...
      return returnMessage(false, "Deleted Product", eliminatedProduct);
    } catch (error) {
      return returnMessage(true, "Error erasing product", null);
    }
  }
  ...
  async deleteAll() {
    try {
      ...
      return returnMessage(false, "Eliminated Product", null);
    } catch (error) {
      return returnMessage(true, "Error eliminating products", null);
    }
  }
  ...
  async updateById(id, newProduct) {
    try {
      ...
      return returnMessage(true, "Error updating proudct", null);
    }
  }
}
